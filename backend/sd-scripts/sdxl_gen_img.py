...
import library.models.sdxl_model_util as sdxl_model_util

from library.models.sdxl_original_unet import InferSdxlUNet2DConditionModel
from library.models.original_unet import FlashAttentionFunction
from library.utils.device_utils import init_ipex, clean_memory, get_preferred_device
from library.utils.common_utils import GradualLatent, EulerAncestralDiscreteSchedulerGL, setup_logging, add_logging_arguments
from library.networks.lora import LoRANetwork
from library.networks.control_net_lllite import ControlNetLLLite
from library.models.text_encoder_util import pool_workaround
from library.models.sdxl_model_util import get_timestep_embedding
from library.training.sdxl_model_prep import _load_target_model
from library.data.sdxl_data_utils import load_tokenizers
...
class PipelineLike:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        uc_emb1 = get_timestep_embedding(
...
def main(args):
    ...
    (_, text_encoder1, text_encoder2, vae, unet, _, _) = _load_target_model(
        args, args.ckpt, args.vae, MODEL_VERSION_SDXL_BASE_V1_0, dtype
    )
    ...
    tokenizer1, tokenizer2 = load_tokenizers(args)
