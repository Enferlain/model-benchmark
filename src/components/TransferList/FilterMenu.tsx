...
export function FilterMenu({
	...
	const isActive =
		filters.modelTypes.size > 0 ||
		filters.predictionTypes.size > 0 ||
	...
	return (
		<div className="relative" ref={menuRef}>
			...
			>
				<Filter size={16} />
				{isActive && (
					<span className="text-xs font-bold w-4 h-4 rounded-full bg-blue-500 text-white flex items-center justify-center -ml-1">
						!
					</span>
				)}
			</button>
