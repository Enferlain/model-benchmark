	...
	return (
		<div className="w-full h-full flex items-center justify-center p-4">
			<div className="relative w-full max-w-[800px] aspect-square select-none overflow-hidden rounded-lg shadow-xl border border-slate-300 dark:border-slate-600 bg-black">
				...
				{/* Labels */}
				<div className="absolute bottom-4 left-4 bg-black/50 text-white px-2 py-1 rounded text-sm pointer-events-none z-10">
					{modelNames[0]}
				</div>
				<div className="absolute bottom-4 right-4 bg-black/50 text-white px-2 py-1 rounded text-sm pointer-events-none z-10">
					{modelNames[1]}
				</div>
				...
				>
					<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg">
						...
						<svg
							...
							strokeLinecap="round"
							strokeLinejoin="round"
							className="text-slate-800 rotate-180 absolute"
						>
							<path d="m9 18 6-6-6-6" />
						</svg>
					</div>
