    ...
    return (
      <div className="w-1/3 min-w-[320px] max-w-[450px] flex flex-col bg-white dark:bg-slate-800/50 rounded-2xl shadow-lg border border-slate-200 dark:border-white/5 overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-4 py-2 border-b border-slate-200 dark:border-white/5 flex gap-2 overflow-x-auto">
             <button onClick={onShuffle} className="p-1.5 px-3 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-300 flex items-center gap-1.5 transition-colors whitespace-nowrap">
                <Shuffle size={12} /> Shuffle
             </button>
             <button onClick={() => onEnableAll(true)} className="p-1.5 px-3 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-300 flex items-center gap-1.5 transition-colors whitespace-nowrap">
                <CheckSquare size={12} /> Enable All
             </button>
             <button onClick={() => onEnableAll(false)} className="p-1.5 px-3 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-300 flex items-center gap-1.5 transition-colors whitespace-nowrap">
      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-center">
            ...
            <div className="text-[10px] font-mono text-slate-400 mb-1 truncate">{prompt.filename}</div>
