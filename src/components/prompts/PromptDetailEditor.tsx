			...
			{prompt ? (
				<>
					...
					<div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
						...
						<div>
							<label
								htmlFor="prompt-alias"
								className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3 flex items-center gap-2"
							>
							...
							<p className="text-[10px] text-slate-400 mt-2 ml-1">
								This alias will be used in the UI and can be used for output
								filenames instead of the raw ID.
							</p>
						</div>
